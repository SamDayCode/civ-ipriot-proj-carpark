...
class CarDetector:
    ...
    def __init__(self):
        ...
        self.spaces_available = 192
        self.car_counter = 0
        # Connect the CarDetector to MQTT
    ...
    def incoming_car(self):
        ...
        print("Car goes in")
        # Create a value to add to a counter
        # car_in = {"cars":1}
        # message_to_send = json.dumps(car_in)
        car_count_send = self.car_counter = self.car_counter + 1
        # Positives only
        if self.car_counter < 0:
            self.car_counter = 0
            car_count_send = self.car_counter
        spaces = self.spaces_available - self.car_counter
        if spaces <0:
            spaces = 0
        ...
        self.client.publish(self.MQTT_topic, message_to_send)
